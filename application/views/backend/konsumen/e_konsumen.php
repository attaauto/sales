          ...
          <form method="post" action="<?= base_url()?>konsumen/update">
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <textarea nama="alamat_konsumen" cols="30" rows="5" class="form-control" placeholder="Input Alamat" required> <?= $konsumen['alamat_konsumen'];?> </textarea>           
            </div> <div class="form-group">
               <input type="text" name="no_telp" class="form-control" value="<?= $konsumen['no_telp'];?>" placeholder="Input No. Telpon" required>
            </div>
            <div class="form-group">
